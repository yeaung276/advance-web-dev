        ...
        return {
            ...
            "lumdist": aliasAndMergeSources(
                [{
                    ...
                    "value": attr.value, 
                    "unit": attr.unit
                } for attr in attributes if attr.name == "lumdist"], 
                sources, 
                "value"
            ),
            "velocity": aliasAndMergeSources(
                [{
                    ...
                    "value": attr.value, 
                    "unit": attr.unit
                } for attr in attributes if attr.name == "velocity"], 
                sources, 
                "value"
            ),
            "redshift": aliasAndMergeSources(
                [{
                    ...
                    "value": attr.value, 
                    "unit": attr.unit
                } for attr in attributes if attr.name == "redshift"], 
                sources, 
                "value"
            ),
            "maxabsmag": aliasAndMergeSources(
                [{
                    ...
                    "value": attr.value, 
                    "unit": attr.unit
                } for attr in attributes if attr.name == "maxabsmag"], 
                sources, 
                "value"
            ),
            "maxappmag": aliasAndMergeSources(
                [{
                    ...
                    "value": attr.value, 
                    "unit": attr.unit
                } for attr in attributes if attr.name == "maxappmag"], 
                sources, 
                "value"
            )
        }
...
def get_alias(source, sources) -> str:
    ...
    alias = str(len(sources) + 2) # 1 for array index connection + 1 for increment counter
    sources.append({
        "id": source.id,
        "name": source.name,
        "url": source.url,
